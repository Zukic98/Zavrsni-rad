...
def runApplication():
    ...
    file_list_column = [
        ...
        [sg.Text('Δr: ', key='-Δr-', font=('Arial ', 10), expand_x=True, justification='left')],
        [sg.Input('', enable_events=True, key='-DELTArINPUT-', font=('Arial Bold', 10), expand_x=True, justification='left')],
    ...
    while True:
        ...
        model.delta_r = values["-DELTArINPUT-"]
